...
testbench(topInputs,signalsTable,elementsTable,signalsSymbols)
print("-----------------------------------------------------------------------------------------")
print("-----------------------------------------------------------------------------------------")
...
score=[]
for i in range(2001):
    score.append(countSwitchesofIndividual(topInputs,signalsTable,elementsTable,signalsSymbols))
lst = list(range(0,2000+1))
# TIME TO MAKE MY GRAPH
plt.plot(lst, score) 
# naming the x axis
